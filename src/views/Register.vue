          ...
          <div class="card-body">
              ...
              <form @submit.prevent="submit">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" v-model="pass1" id="InputPassword1" required>
                </div>
                <div class="mb-3">
                  <label for="InputPassword2" class="form-label">Re-enter Password</label>
                  <input type="password" class="form-control" v-model="pass2" id="InputPassword2" required>
                </div>
